import createTAP_EqualizerBWPlugin from './TAP_EqualizerBW.js';

let mod = null;
const inPtrs  = [0];
const outPtrs = [0];
const SETTERS = {"Band1GainDb":"_shim_set_Band1GainDb","Band2GainDb":"_shim_set_Band2GainDb","Band3GainDb":"_shim_set_Band3GainDb","Band4GainDb":"_shim_set_Band4GainDb","Band5GainDb":"_shim_set_Band5GainDb","Band6GainDb":"_shim_set_Band6GainDb","Band7GainDb":"_shim_set_Band7GainDb","Band8GainDb":"_shim_set_Band8GainDb","Band1FreqHz":"_shim_set_Band1FreqHz","Band2FreqHz":"_shim_set_Band2FreqHz","Band3FreqHz":"_shim_set_Band3FreqHz","Band4FreqHz":"_shim_set_Band4FreqHz","Band5FreqHz":"_shim_set_Band5FreqHz","Band6FreqHz":"_shim_set_Band6FreqHz","Band7FreqHz":"_shim_set_Band7FreqHz","Band8FreqHz":"_shim_set_Band8FreqHz","Band1BandwidthOctaves":"_shim_set_Band1BandwidthOctaves","Band2BandwidthOctaves":"_shim_set_Band2BandwidthOctaves","Band3BandwidthOctaves":"_shim_set_Band3BandwidthOctaves","Band4BandwidthOctaves":"_shim_set_Band4BandwidthOctaves","Band5BandwidthOctaves":"_shim_set_Band5BandwidthOctaves","Band6BandwidthOctaves":"_shim_set_Band6BandwidthOctaves","Band7BandwidthOctaves":"_shim_set_Band7BandwidthOctaves","Band8BandwidthOctaves":"_shim_set_Band8BandwidthOctaves"};
...
class WadspProcessor extends AudioWorkletProcessor {
    constructor() {
        ...
        this.port.onmessage = async ({ data }) => {
            if (data.type === 'setup') {
                try {
                    mod = await createTAP_EqualizerBWPlugin({ wasmBinary: data.wasm, locateFile: (p, d) => d + p });
...
registerProcessor('wadspa-TAP_EqualizerBW', WadspProcessor);
