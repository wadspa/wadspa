import createJuceOPLPlugin from './JuceOPL.js';

let mod = null;
const inPtrs  = [];
const outPtrs = [0, 0];
const SETTERS = {"carrier_wave":"_shim_set_carrier_wave","modulator_wave":"_shim_set_modulator_wave","carrier_multiplier":"_shim_set_carrier_multiplier","modulator_multiplier":"_shim_set_modulator_multiplier","carrier_attenuation":"_shim_set_carrier_attenuation","modulator_attenuation":"_shim_set_modulator_attenuation","carrier_tremolo":"_shim_set_carrier_tremolo","carrier_vibrato":"_shim_set_carrier_vibrato","modulator_tremolo":"_shim_set_modulator_tremolo","modulator_vibrato":"_shim_set_modulator_vibrato","carrier_keyscale_level":"_shim_set_carrier_keyscale_level","modulator_keyscale_level":"_shim_set_modulator_keyscale_level","algorithm":"_shim_set_algorithm","modulator_feedback":"_shim_set_modulator_feedback","carrier_attack":"_shim_set_carrier_attack","modulator_attack":"_shim_set_modulator_attack","carrier_velocity_sensitivity":"_shim_set_carrier_velocity_sensitivity","modulator_velocity_sensitivity":"_shim_set_modulator_velocity_sensitivity"};
...
class WadspProcessor extends AudioWorkletProcessor {
    constructor() {
        ...
        this.port.onmessage = async ({ data }) => {
            if (data.type === 'setup') {
                try {
                    mod = await createJuceOPLPlugin({ wasmBinary: data.wasm, locateFile: (p, d) => d + p });
...
registerProcessor('wadspa-JuceOPL', WadspProcessor);
