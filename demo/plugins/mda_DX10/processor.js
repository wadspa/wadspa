import createMDA_DX10Plugin from './MDA_DX10.js';

let mod = null;
const inPtrs  = [];
const outPtrs = [0, 0];
const SETTERS = {"attack":"_shim_set_attack","decay":"_shim_set_decay","release":"_shim_set_release","coarse":"_shim_set_coarse","fine":"_shim_set_fine","mod_init":"_shim_set_mod_init","mod_dec":"_shim_set_mod_dec","mod_sus":"_shim_set_mod_sus","mod_rel":"_shim_set_mod_rel","mod_vel":"_shim_set_mod_vel","vibrato":"_shim_set_vibrato","octave":"_shim_set_octave","finetune":"_shim_set_finetune","waveform":"_shim_set_waveform","mod_thru":"_shim_set_mod_thru","lfo_rate":"_shim_set_lfo_rate"};
...
class WadspProcessor extends AudioWorkletProcessor {
    constructor() {
        ...
        this.port.onmessage = async ({ data }) => {
            if (data.type === 'setup') {
                try {
                    mod = await createMDA_DX10Plugin({ wasmBinary: data.wasm, locateFile: (p, d) => d + p });
...
registerProcessor('wadspa-MDA_DX10', WadspProcessor);
