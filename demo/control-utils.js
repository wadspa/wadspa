...
const ACTIVE_RANGE_TRIMS = [
  ...
  { name: 'Decay (ms)', min: 2, max: 4000, low: 0.25, high: 0.75 },
  ...
  { symbol: 'feedback', name: 'Feedback', min: 0, max: 1, default: 0.85, low: 0.5 },
  { symbol: 'amp_decay', name: 'Amp Decay', min: 0, max: 0.65, low: 0.25 },
  { symbol: 'filter_release', name: 'Filter Release', min: 0, max: 2.5, high: 0.25 },
  ...
  { symbol: 'DCF1_RELEASE', name: 'DCF1 Release', min: 0, max: 1, high: 0.25 },
  { symbol: 'DCF2_RELEASE', name: 'DCF2 Release', min: 0, max: 1, high: 0.25 },
  { symbol: 'LFO1_RELEASE', name: 'LFO1 Release', min: 0, max: 1, high: 0.5 },
  { symbol: 'LFO2_RELEASE', name: 'LFO2 Release', min: 0, max: 1, high: 0.25 },
  { symbol: 'word_len', name: 'Word Len', min: 8, max: 24, high: 0.5 },
  { symbol: 'slew', name: 'Slew', min: 1, max: 150, high: 0.5 },
  ...
  { symbol: 'rel', name: 'Release', min: 0.10000000149, max: 500, low: 0.85 },
];
