import createdj_eq_monoPlugin from './dj_eq_mono.js';

let mod = null;
const inPtrs  = [0];
const outPtrs = [0];
const SETTERS = {"0":"_shim_set_lo_gain_db","1":"_shim_set_mid_gain_db","2":"_shim_set_hi_gain_db"};
...
registerProcessor('wadspa-dj_eq_mono', WadspProcessor);
