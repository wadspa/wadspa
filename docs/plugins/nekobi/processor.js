import createDISTRHO_NekobiPlugin from './DISTRHO_Nekobi.js';

let mod = null;
const inPtrs  = [];
const outPtrs = [0, 0];
const SETTERS = {"waveform":"_shim_set_waveform","tuning":"_shim_set_tuning","cutoff":"_shim_set_cutoff","resonance":"_shim_set_resonance","env_mod":"_shim_set_env_mod","decay":"_shim_set_decay","accent":"_shim_set_accent","volume":"_shim_set_volume"};
...
registerProcessor('wadspa-DISTRHO_Nekobi', WadspProcessor);
