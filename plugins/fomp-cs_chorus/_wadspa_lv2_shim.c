...
static float g_ctrl_delay = 0.0f;
static float g_ctrl_mod_freq_1 = 0.0f;
static float g_ctrl_mod_amp_1 = 0.0f;
static float g_ctrl_mod_freq_2 = 0.0f;
static float g_ctrl_mod_amp_2 = 0.0f;
...
EMSCRIPTEN_KEEPALIVE void shim_init(unsigned long sample_rate) {
    ...
    { const char *_uri = "http://drobilla.net/plugins/fomp/cs_chorus1";
      for (int _i = 0; ; _i++) {
    ...
    g_desc->connect_port(g_handle, 2, &g_ctrl_delay);
    g_desc->connect_port(g_handle, 3, &g_ctrl_mod_freq_1);
    g_desc->connect_port(g_handle, 4, &g_ctrl_mod_amp_1);
    g_desc->connect_port(g_handle, 5, &g_ctrl_mod_freq_2);
    g_desc->connect_port(g_handle, 6, &g_ctrl_mod_amp_2);
...
EMSCRIPTEN_KEEPALIVE void  shim_set_mod_freq_1(float v) { g_ctrl_mod_freq_1 = v; }
EMSCRIPTEN_KEEPALIVE float shim_get_mod_freq_1()        { return g_ctrl_mod_freq_1; }
EMSCRIPTEN_KEEPALIVE void  shim_set_mod_amp_1(float v) { g_ctrl_mod_amp_1 = v; }
EMSCRIPTEN_KEEPALIVE float shim_get_mod_amp_1()        { return g_ctrl_mod_amp_1; }
EMSCRIPTEN_KEEPALIVE void  shim_set_mod_freq_2(float v) { g_ctrl_mod_freq_2 = v; }
EMSCRIPTEN_KEEPALIVE float shim_get_mod_freq_2()        { return g_ctrl_mod_freq_2; }
EMSCRIPTEN_KEEPALIVE void  shim_set_mod_amp_2(float v) { g_ctrl_mod_amp_2 = v; }
EMSCRIPTEN_KEEPALIVE float shim_get_mod_amp_2()        { return g_ctrl_mod_amp_2; }
