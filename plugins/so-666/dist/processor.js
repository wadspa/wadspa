import createSO666_Feedback_SynthesizerPlugin from './SO666_Feedback_Synthesizer.js';

let mod = null;
const inPtrs  = [];
const outPtrs = [0];
const SETTERS = {"controlmode":"_shim_set_controlmode","feedback":"_shim_set_feedback","resonance":"_shim_set_resonance","cutoff":"_shim_set_cutoff","volume":"_shim_set_volume","channel":"_shim_set_channel"};
...
registerProcessor('wadspa-SO666_Feedback_Synthesizer', WadspProcessor);
