import createMDA_JX10Plugin from './MDA_JX10.js';

let mod = null;
const inPtrs  = [];
const outPtrs = [0, 0];
const SETTERS = {"osc_mix":"_shim_set_osc_mix","osc_tune":"_shim_set_osc_tune","osc_fine":"_shim_set_osc_fine","glide":"_shim_set_glide","gld_rate":"_shim_set_gld_rate","gld_bend":"_shim_set_gld_bend","vcf_freq":"_shim_set_vcf_freq","vcf_reso":"_shim_set_vcf_reso","vcf_env":"_shim_set_vcf_env","vcf_lfo":"_shim_set_vcf_lfo","vcf_vel":"_shim_set_vcf_vel","vcf_att":"_shim_set_vcf_att","vcf_dec":"_shim_set_vcf_dec","vcf_sus":"_shim_set_vcf_sus","vcf_rel":"_shim_set_vcf_rel","env_att":"_shim_set_env_att","env_dec":"_shim_set_env_dec","env_sus":"_shim_set_env_sus","env_rel":"_shim_set_env_rel","lfo_rate":"_shim_set_lfo_rate","vibrato":"_shim_set_vibrato","noise":"_shim_set_noise","octave":"_shim_set_octave","tuning":"_shim_set_tuning"};
...
class WadspProcessor extends AudioWorkletProcessor {
    constructor() {
        ...
        this.port.onmessage = async ({ data }) => {
            if (data.type === 'setup') {
                try {
                    mod = await createMDA_JX10Plugin({ wasmBinary: data.wasm, locateFile: (p, d) => d + p });
...
registerProcessor('wadspa-MDA_JX10', WadspProcessor);
