...
#line 10 "/Users/sethtenenbaum/wadspa/swh-plugins/gate_1921.xml"
...
#line 41 "/Users/sethtenenbaum/wadspa/swh-plugins/gate_1921.xml"
	env = 0.0f;
	gate = 0.0f;
	state = CLOSED;
	biquad_init(lf);
...
#line 28 "/Users/sethtenenbaum/wadspa/swh-plugins/gate_1921.xml"
	fs = s_rate;
	env = 0.0f;
	gate = 0.0f;
	state = CLOSED;
...
#line 49 "/Users/sethtenenbaum/wadspa/swh-plugins/gate_1921.xml"
	unsigned long pos;
...
static LADSPA_Handle instantiateStereo_gate(
 const LADSPA_Descriptor *descriptor,
 unsigned long s_rate) {
	Stereo_gate *plugin_data = (Stereo_gate *)calloc(1, sizeof(Stereo_gate));
	float env;
	float fs;
	float gate;
	biquad *hf = NULL;
