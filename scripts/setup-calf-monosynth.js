#!/usr/bin/env node
/**
 * Setup script for Calf Monosynth.
 *
 * The upstream Calf synth lives inside the larger Calf module framework. This
 * setup preserves the Monosynth browser-facing control path and hosts a compact
 * monophonic virtual-analog engine directly as an LV2 MIDI instrument. The
 * ranges are kept audible for Web Audio slider sweeps, especially time and
 * frequency controls that otherwise spend most of their travel outside the
 * automated render window.
 */
...
const SRC = join(ROOT, 'calf', 'src', 'monosynth.cpp');
const OUT = join(ROOT, 'plugins', 'calf-monosynth');
...
const filterNames = [
    ['12dB/oct Lowpass', 0],
    ['24dB/oct Lowpass', 1],
    ['2x12dB/oct Lowpass', 2],
    ['12dB/oct Highpass', 3],
    ['Lowpass+Notch', 4],
    ['Highpass+Notch', 5],
    ['6dB/oct Bandpass', 6],
    ['2x6dB/oct Bandpass', 7],
];
...
const controls = [
    { symbol: 'o1_wave', name: 'Osc1 Wave', min: 0, max: 15, def: 0, integer: true, scalePoints: waveNames },
    { symbol: 'o2_wave', name: 'Osc2 Wave', min: 0, max: 15, def: 1, integer: true, scalePoints: waveNames },
    { symbol: 'o1_pw', name: 'Osc1 PW', min: -1, max: 1, def: 0 },
    { symbol: 'o2_pw', name: 'Osc2 PW', min: -1, max: 1, def: 0 },
    { symbol: 'o12_detune', name: 'O1<>2 Detune', min: 0, max: 100, def: 10 },
    { symbol: 'o2_xpose', name: 'Osc2 Transpose', min: -24, max: 24, def: 12, integer: true },
    { symbol: 'phase_mode', name: 'Phase Mode', min: 0, max: 5, def: 0, integer: true, scalePoints: phaseNames },
    { symbol: 'o12_mix', name: 'O1<>2 Mix', min: 0, max: 1, def: 0.5 },
    { symbol: 'filter', name: 'Filter Mode', min: 0, max: 7, def: 1, integer: true, scalePoints: filterNames },
    { symbol: 'cutoff', name: 'Cutoff Hz', min: 20, max: 16000, def: 1200, logarithmic: true },
    { symbol: 'res', name: 'Resonance', min: 0.7, max: 8, def: 2.2 },
    { symbol: 'filter_sep', name: 'Filter Separation', min: -2400, max: 2400, def: 0 },
    { symbol: 'env2cutoff', name: 'EG1->Cutoff', min: -4800, max: 4800, def: 1200 },
    { symbol: 'env2res', name: 'EG1->Res', min: 0, max: 1, def: 0.2 },
    { symbol: 'env2amp', name: 'EG1->Amp', min: 0, max: 1, def: 0, integer: true, toggled: true },
    { symbol: 'adsr_a', name: 'EG1 Attack ms', min: 1, max: 2000, def: 8, logarithmic: true },
    { symbol: 'adsr_d', name: 'EG1 Decay ms', min: 10, max: 2000, def: 350, logarithmic: true },
    { symbol: 'adsr_s', name: 'EG1 Sustain', min: 0, max: 1, def: 0.5 },
    { symbol: 'adsr_r', name: 'EG1 Release ms', min: 10, max: 2000, def: 120, logarithmic: true },
    { symbol: 'key_follow', name: 'Key Follow', min: 0, max: 2, def: 0.35 },
    { symbol: 'portamento', name: 'Portamento ms', min: 1, max: 1000, def: 15, logarithmic: true },
    { symbol: 'vel2filter', name: 'Vel->Filter', min: 0, max: 1, def: 0.5 },
    { symbol: 'vel2amp', name: 'Vel->Amp', min: 0, max: 1, def: 0.25 },
    { symbol: 'master', name: 'Volume', min: 0, max: 1, def: 0.7 },
    { symbol: 'pbend_range', name: 'PBend Range', min: 0, max: 2400, def: 200 },
    { symbol: 'lfo_rate', name: 'LFO1 Rate Hz', min: 0.05, max: 20, def: 5, logarithmic: true },
    { symbol: 'lfo_delay', name: 'LFO1 Delay sec', min: 0, max: 2, def: 0.2 },
    { symbol: 'lfo2filter', name: 'LFO1->Filter', min: -2400, max: 2400, def: 0 },
    { symbol: 'lfo2pitch', name: 'LFO1->Pitch', min: 0, max: 1200, def: 100 },
    { symbol: 'lfo2pw', name: 'LFO1->PW', min: 0, max: 1, def: 0.15 },
    { symbol: 'mwhl2lfo', name: 'ModWheel->LFO1', min: 0, max: 1, def: 1 },
    { symbol: 'adsr2_cutoff', name: 'EG2->Cutoff', min: -4800, max: 4800, def: 0 },
    { symbol: 'adsr2_res', name: 'EG2->Res', min: 0, max: 1, def: 0.2 },
    { symbol: 'adsr2_amp', name: 'EG2->Amp', min: 0, max: 1, def: 1, integer: true, toggled: true },
    { symbol: 'adsr2_a', name: 'EG2 Attack ms', min: 1, max: 2000, def: 5, logarithmic: true },
    { symbol: 'adsr2_d', name: 'EG2 Decay ms', min: 10, max: 2000, def: 180, logarithmic: true },
    { symbol: 'adsr2_s', name: 'EG2 Sustain', min: 0, max: 1, def: 0.55 },
    { symbol: 'adsr2_r', name: 'EG2 Release ms', min: 10, max: 2000, def: 80, logarithmic: true },
    { symbol: 'o1_stretch', name: 'Osc1 Stretch', min: 1, max: 16, def: 1, logarithmic: true },
    { symbol: 'o1_window', name: 'Osc1 Window', min: 0, max: 1, def: 0 },
    { symbol: 'o2_unison', name: 'Osc2 Unison', min: 0, max: 1, def: 0.1 },
    { symbol: 'o2_unisonfrq', name: 'Osc2 Unison Detune Hz', min: 0.05, max: 20, def: 2, logarithmic: true },
    { symbol: 'o1_xpose', name: 'Osc1 Transpose', min: -24, max: 24, def: 0, integer: true },
];
...
writeFileSync(join(OUT, 'calf_monosynth_lv2.cpp'), lv2WrapperSource());
writeFileSync(join(OUT, 'calf-monosynth.ttl'), ttlSource());
writeFileSync(join(OUT, 'manifest.ttl'), manifestSource());
registerPlugin();

console.log('Calf Monosynth setup complete');
console.log('Run: node scripts/build-instruments.js --only calf-monosynth');
...
<http://calf.sourceforge.net/plugins/Monosynth>
    ...
    lv2:binary <calf-monosynth.so> ;
    rdfs:seeAlso <calf-monosynth.ttl> .
`;
}
...
<http://calf.sourceforge.net/plugins/Monosynth>
    ...
    doap:description "Calf virtual-analog monophonic synthesizer" ;
...
function registerPlugin() {
    const entry = {
        id: 'calf-monosynth',
        description: 'Calf Monosynth - virtual analog monophonic synthesizer',
        category: 'Instruments',
        sources: [
            'calf_monosynth_lv2.cpp',
        ],
        includes: [
            'plugins/calf-monosynth',
        ],
        defines: [
            'NDEBUG',
        ],
    ...
    const existing = registry.findIndex(item => item.id === 'calf-monosynth');
